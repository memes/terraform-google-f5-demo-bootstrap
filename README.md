...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_f5_ai_harbor_password"></a> [f5\_ai\_harbor\_password](#module\_f5\_ai\_harbor\_password) | memes/secret-manager/google | 2.2.2 |
...
| [google-beta_google_project_service_identity.ar](https://registry.terraform.io/providers/hashicorp/google-beta/latest/docs/resources/google_project_service_identity) | resource |
...
| [google_artifact_registry_repository.upstream_f5_ai](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/artifact_registry_repository) | resource |
| [google_artifact_registry_repository.upstream_nginx](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/artifact_registry_repository) | resource |
| [google_artifact_registry_repository.virtual](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/artifact_registry_repository) | resource |
...
| [google_secret_manager_secret_iam_member.ar_f5_ai](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/secret_manager_secret_iam_member) | resource |
...
| <a name="input_f5_ai_harbor_credentials"></a> [f5\_ai\_harbor\_credentials](#input\_f5\_ai\_harbor\_credentials) | An optional username and password pair that will be stored in Google Secret Manager. If provided, a remote Artifact<br/>Registry will be created to reference the upstream F5 AI private Harbor repository for transparent access to the<br/>private images, along with a Secret Manager secret to contain the Harbor password. | <pre>object({<br/>    username = string<br/>    password = string<br/>  })</pre> | `null` | no |
| <a name="input_f5_ai_license"></a> [f5\_ai\_license](#input\_f5\_ai\_license) | An optional F5 AI license to store in Google Secret Manager.<br/>NOTE: Principal access to the secret will not be established by this module; module consumers will be required to<br/>assign the appropriate IAM roles to read or modify the secret as needed. | `string` | `null` | no |
...
| <a name="output_f5_ai_license"></a> [f5\_ai\_license](#output\_f5\_ai\_license) | If an F5 AI license secret was created during bootstrap, return the fully-qualified and local identifiers, and<br/>expiration timestamp, if appropriate. |
